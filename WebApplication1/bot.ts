...
class Bot {
  ...
  functionId = 0;     // impossible id https://developer.mozilla.org/en-US/docs/Web/API/setInterval
  ...
  doSomething() {
    ...
    if ((document.getElementById("outButton") as HTMLButtonElement).disabled == false) {
      racingDemon.out();
      return;
    }
