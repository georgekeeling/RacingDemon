...
connection.on("pingPileBack", function (bCardsBack) {
...
connection.on("pingBack", function (myCID) {
...
connection.on("pingDataBack", function (numBack, dataBack) {
    let endT = new Date();
